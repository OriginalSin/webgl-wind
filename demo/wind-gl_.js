...
var drawVert = document.getElementById('drawVert').text;
var drawFrag = document.getElementById('drawFrag').text;
var quadVert = document.getElementById('quadVert').text;
var screenFrag = document.getElementById('screenFrag').text;
var updateFrag = document.getElementById('updateFrag').text;
